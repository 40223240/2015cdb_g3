#@+leo-ver=5-thin
#@+node:2015.20150625165524.2: * @file wsgi.py
# coding=utf-8
...
#@+<<declarations>>
#@+node:2015.20150625165524.4: ** <<declarations>> (wsgi)
import cherrypy
...
#@-<<declarations>>
#@+others
#@+node:2015.20150625165524.3: ** newHeadline
#@@killcolor


#@+node:2015.20150625165524.5: ** class Hello
################# (3) 程式類別定義區
...
class Hello(object):
    ...
    #@+others
    #@+node:2015.20150625165524.6: *3* __init__
    def __init__(self):
        # 配合透過案例啟始建立所需的目錄
    ...
    #@+node:2015.20150625165524.7: *3* index_orig
    ...
    def index_orig(self, toprint="Hello World!"):
        return toprint
    #@+node:2015.20150625165524.8: *3* hello
    @cherrypy.expose
    def hello(self, toprint="Hello World!"):
        return toprint
    #@+node:2015.20150625165524.9: *3* index
    # 以 @ 開頭的 cherrypy.expose 為 decorator, 用來表示隨後的成員方法, 可以直接讓使用者以 URL 連結執行
    @cherrypy.expose
    # index 方法為 CherryPy 各類別成員方法中的內建(default)方法, 當使用者執行時未指定方法, 系統將會優先執行 index 方法
    # 有 self 的方法為類別中的成員方法, Python 程式透過此一 self 在各成員方法間傳遞物件內容
    def index(self):
        ...
        return outstring
    #@+node:2015.20150625165524.10: *3* drawspur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.11: *3* drawspuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.12: *3* twoDgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.13: *3* threeDgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.14: *3* do2Dgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.15: *3* do3Dgear
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.16: *3* mygeartest
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.17: *3* mygeartest3
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.18: *3* my3Dgeartest
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150625165524.19: *3* doCheck
    @cherrypy.expose
    ...
    #@+node:2015.20150625165524.20: *3* guessform
    def guessform(self):
        # 印出讓使用者輸入的超文件表單
