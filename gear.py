...
#@-<<declarations>>
#@+others
#@+node:2015.20150625165524.23: ** class Gear
class Gear(object):
    #@+others
    #@+node:2015.20150625165524.24: *3* __init__
    def __init__(self):
        ...
        if not os.path.isdir(download_root_dir+"tmp"):
            try:
                ...
                print("mkdir error")
    #@+node:2015.20150625165524.25: *3* default
    @cherrypy.expose
    def default(self, attr='default', *args, **kwargs):
        raise cherrypy.HTTPRedirect("/")
    #@+node:2015.20150625165524.26: *3* index
...
'''
        ...
        return outstring
    #@+node:2015.20150625165524.27: *3* interpolation
    @cherrypy.expose
    ...
    #@+node:2015.20150625165524.28: *3* gear_width
    # 改寫為齒面寬的設計函式
    @cherrypy.expose
    def gear_width(self, horsepower=100, rpm=1000, ratio=4, toothtype=1, safetyfactor=2, material_serialno=1, npinion=18):
        ...
        return outstring
    #@+node:2015.20150625165524.29: *3* cube_weblink
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2015.20150625165524.30: *3* gear_weblink
    @cherrypy.expose
